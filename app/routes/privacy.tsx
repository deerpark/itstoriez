    ...
    <Layout {...{ title, Icon, desc, sidebar, prevRoute, isWide: true }}>
      <div className='bx-privacy prose-sm prose-slate dark:prose-invert'>
        <p className='ls2 lh6 bs5 ts4'>
          <em className='emphasis'>&lt;ITStoriEZ&gt;('https://itstoriez.vercel.app'이하 'ITStoriEZ')</em>은(는) 「개인정보
        ...
        <p className='lh6 bs4'>
          ...
          <br />
          <br />
          <em className='emphasis'>&lt;ITStoriEZ&gt;('https://itstoriez.vercel.app'이하 'ITStoriEZ')</em>은(는) 다음의 목적을
        ...
        <p className='lh6 bs4'>
          ...
          <br />
          <br />① <em className='emphasis'>&lt;ITStoriEZ&gt;</em>은(는) 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <p className='ls2'>
          <br />
          <br />① 정보주체는 &lt;ITStoriEZ&gt;에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수
          있습니다.
        </p>
        <p className='sub_p'>
          ② 제1항에 따른 권리 행사는 &lt;ITStoriEZ&gt;에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면,
          전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 &lt;ITStoriEZ&gt;은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p className='sub_p'>
        ...
        <p className='sub_p'>
          ⑥ &lt;ITStoriEZ&gt;은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를
        ...
        <p className='lh6 bs4'>
          ...
          <br />
          <br /> ① <em className='emphasis'>&lt;ITStoriEZ&gt;</em>은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        </p>
        <ul className='list_indent2 mgt10'>
        ...
        <p className='sub_p mgt10'>
          ...
          <br />
          3. 해킹 등에 대비한 기술적 대책
          <br /> &lt;<em className='emphasis'>ITStoriEZ</em>&gt;('<em className='emphasis'>ITStoriEZ</em>')은 해킹이나
        ...
        <p className='ls2'>
          <br />
          <br />① &lt;ITStoriEZ&gt; 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로
        ...
        <p className='sub_p mgt10'>
          ① <span className='colorLightBlue'>&lt;ITStoriEZ&gt;</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서
        ...
        <p className='sub_p'>
          ...
          <p className='sub_p'>
            ② 정보주체께서는 &lt;ITStoriEZ&gt; 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
            불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. &lt;ITStoriEZ&gt;
